...
자율매매 실적`으로 분리하고 1번 통합 운영·안전 코어의 관제 Pages에서 세 화면을
연결한다. 6번에는 최초 투자금, 현재 투자금, 실현·평가·누적 손익, 수익률과
...
최근 조치와 4~6번 링크를 표시한다. 모든 상태는 Python 헬스체크 결과에서 생성하고
...
- 번호 체계: `1 통합 운영·안전 코어`, `2 시장 센싱`, `3 자율매매`,
