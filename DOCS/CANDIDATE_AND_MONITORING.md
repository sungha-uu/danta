...
현재 계산 버전은 `intraday-actual-10pct-gate-v13-visible-extrema-top200-official30-all-reviewed-kospi-market-cap-top200-v1`이다.
...
- 내부 200개의 정량 구조를 계산한 뒤 14일 자격 게이트를 통과한 최대 30개만 공식 후보로 고정한다. 7·14·21일 탭은 같은 공식 후보 순서를 유지하며 해당 기간 지표만 변경한다.
...
| AI 심층검토 | 공식 후보 전체의 수급·뉴스·공시·토론·재무 위험 |
...
GitHub Pages에는 14일 자격 게이트를 통과한 공식 후보를 최대 30개 게시한다. 7·14·21일 탭은 동일 종목군과 동일 순번을 유지하고, 각 기간의 실제 분봉 지표·수급·등급·코멘트만 변경한다.
