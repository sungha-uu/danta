...
따라서 `하단 추세 -N%`만으로 공식 후보를 탈락시키거나 AI 비추천으로 만들지 않는다. AI는 `고점 대비 현재 할인 폭 × 과거 단기 반복 상승 여력 × 당일 외국인·기관 자금 유입`을 핵심으로 평가한다. 하락폭이 클수록 잠재 보상은 커질 수 있지만 자동 진입 확률이 높아지는 것은 아니다. 실제 진입은 최근 1분봉의 추가 하락 둔화와 매수세 회복, KIS 장중 외국인·기관 합산 추정 순유입이 함께 확인된 뒤에만 허용한다. 전일 보고서 수급은 장중 자금 유출을 대체할 수 없다.

장중 자율 후보의 우선순위는 손절 이력과 무관하게 `기간 고점 대비 할인 폭이 큰
종목 → 당일 외국인+기관 수급강도가 큰 종목 → 반복 상승 정량 순위가 높은 종목`
순으로 비교한다. 단, 당일 합산 수급이 음수이거나 최소 수급강도에 못 미치면 할인
폭이 아무리 커도 신규매수 대상으로 지정하지 않는다.
